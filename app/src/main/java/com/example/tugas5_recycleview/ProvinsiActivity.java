...
import com.example.tugas5_recycleview.databinding.ActivityProvinsiBinding;
...
public class ProvinsiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityProvinsiBinding.inflate(getLayoutInflater());
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_presiden) {
                    Intent a = new Intent(ProvinsiActivity.this, DestinationActivity.class);
                    startActivity(a);
                } else if (id == R.id.nav_provinsi) {
                    Intent a = new Intent(ProvinsiActivity.this, ProvinsiActivity.class);
                    startActivity(a);
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(ProvinsiActivity.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                    binding.edtname.setText("");
                    binding.edtimage.setImageResource(R.mipmap.ic_launcher);
                    binding.edtstar.setText("");
                    binding.edtprice.setText("");
                } else {
                    Toast.makeText(ProvinsiActivity.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ProvinsiActivity.this, DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(ProvinsiActivity.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(ProvinsiActivity.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
